...
<body>
    ...
    <header>
        <div class="header-left"><h1>Goal Calendar</h1></div>
        ...
        <section class="card">
            <div class="section-header">
                ...
                <div class="header-actions">
                    <a href="goal.php" class="primary">&larr; Back to List View</a>
                </div>
            </div>
            <div id="calendar"></div>
        </section>
    ...
    <script src="JS/goal_calendar.js"></script>
</body>
</html>